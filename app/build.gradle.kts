...
//    implementation(libs.gdx)
    ...
    // KTX dependencies for Kotlin support
...
//    implementation(libs.ktx.app)
//    implementation(libs.ktx.graphics)
//    implementation(libs.lwjgl.glfw)  // LWJGL3 GLFW for windowing/input
//    implementation(libs.lwjgl)  // Core LWJGL3 for OpenGL bindings
}